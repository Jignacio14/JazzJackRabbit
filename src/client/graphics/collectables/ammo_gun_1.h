#ifndef AMMO_GUN_1_COLLECTABLE_H
...
class AmmoGun1 : public Renderable {
private:
...
public:
  AmmoGun1(GraphicEngine &graphicEngine, Coordinates &currentCoords,
...
#endif // AMMO_GUN_1_COLLECTABLE_H
